      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs leading-relaxed text-muted">
            Injects {SIMULATION_SCENARIOS.length} historical high-impact headlines into the full AI
            pipeline. Watch real-time analysis, trade decisions, and Alpaca order execution even
          ...
          {isRunning && (
            <div className="mt-3 space-y-2">
              <div className="flex justify-between font-mono text-[10px] text-muted">
                ...
                <span>
                  {progress} / {SIMULATION_SCENARIOS.length}
                </span>
              </div>
              ...
              {next && (
                <p className="truncate text-[10px] text-muted">
                  Next: <span className="font-mono font-medium text-accent">{next.ticker}</span>
                  {' - '}
