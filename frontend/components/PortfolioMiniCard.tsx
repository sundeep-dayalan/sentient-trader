  ...
  return (
    <div className="rounded-xl border border-line bg-surface-2 p-3.5">
      ...
      <div className="mt-3">
        ...
        <p className={`mt-1 font-mono text-[12px] font-semibold ${isUp ? "text-positive" : "text-negative"}`}>
      ...
      <div className="mt-3 h-10 overflow-hidden rounded-lg border border-line bg-surface">
        {points ? (
          <svg viewBox="0 0 176 40" className="h-full w-full" preserveAspectRatio="none" aria-hidden="true">
            <defs>
